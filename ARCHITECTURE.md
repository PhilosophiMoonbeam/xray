...
product runtime.
The [next-major design packet](docs/next-major-design-packet-v2.md) freezes
implementation design authorized under Bead `xray-5e7`, not implemented behavior.
XRAY 0.11.4 remains the current runtime contract until I5 acceptance. Harness
authority remains [adoption Design Packet v2](docs/adoption-design-packet-v2.md).
