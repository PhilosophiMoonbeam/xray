...
# fmt: off
PROJECT_SECTIONS = "Purpose|Architecture|Integration branch|Component ownership|Canonical command catalog|Delivery authority|External and shared resources|Sensitive and destructive operations|Required nested instructions|CI and Enterprise qualification|Compatibility, risks, and rollback|Evidence".split("|")
